...
class AscendCommonAttentionMetadata(CommonAttentionMetadata):
    ...
    # CPU tensor of per-request prompt token count (fixed prefill length /
    # decode starting point). Used by windowed KV quantization to anchor the
    # high-precision window on the decode region. Defensive: may be None under
    # async_spec_decode.
